...
public class PentaLettersActionGenerateLogical extends PuzzleActionSolve {
	PentaLettersLogicalGenerator generator = new PentaLettersLogicalGenerator();

	public PentaLettersActionGenerateLogical() {
