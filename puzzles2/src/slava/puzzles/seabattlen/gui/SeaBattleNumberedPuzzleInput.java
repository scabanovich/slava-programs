...
public class SeaBattleNumberedPuzzleInput extends KeyAdapter implements SeaBattleConstants {
	static int STATE_B = 0;
	static int STATE_H = 1;
	static int STATE_V = 2;
	static int STATE_S = 3;
	SeaBattleNumberedModel model;
	SeaBattleNumberedComponent component;
	...
	public void setComponent(SeaBattleNumberedComponent component) {
